...
func GetMarketKlineResponse(data []byte, res *models.MarketKlineResponse) (*models.MarketKlineResponse, *models.MarketKlineResponse, error) {
	j, err := newJSON(data)
	if err != nil {
		return nil, nil, err
	}
...
func GetIndexPriceKline(data []byte, res *models.MarketIndexPriceKlineResponse) (*models.MarketIndexPriceKlineResponse, error) {
	j, err := newJSON(data)
	if err != nil {
		return nil, err
	}
